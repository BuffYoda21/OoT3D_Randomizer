...
void InitEnemyTypes(void) {
    enemyTypes[ENEMY_INVALID] = EnemyType("Invalid Enemy", 0, { 0 }, {});
    enemyTypes[ENEMY_POE] = EnemyType("Poe", &SoulPoe, { 0x0000, 0x0002, 0x0003 }, // normal, Sharp, Flat
    ...
    enemyTypes[ENEMY_STALFOS] = EnemyType("Stalfos", &SoulStalfos, { 0x0002, 0x0003 }, // rises from ground / drops from above when approached
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER, LocType::SPAWNER });
    enemyTypes[ENEMY_OCTOROK] = EnemyType("Octorok", &SoulOctorok, { 0x0000 },
        { LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_WALLMASTER] = EnemyType("Wallmaster", &SoulWallmaster, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_DODONGO] = EnemyType("Dodongo (Normal)", &SoulDodongo, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_KEESE_NORMAL] = EnemyType("Keese (Normal)", &SoulKeese, { 0x0002 },
    ...
    enemyTypes[ENEMY_KEESE_FIRE] = EnemyType("Keese (Fire)", &SoulKeese, { 0x0001 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_KEESE_ICE] = EnemyType("Keese (Ice)", &SoulKeese, { 0x0004 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::UNDERWATER, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_TEKTITE_RED] = EnemyType("Tektite (Red)", &SoulTektite, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_TEKTITE_BLUE] = EnemyType("Tektite (Blue)", &SoulTektite, { 0xFFFE },
        { LocType::ABOVE_GROUND, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_LEEVER] = EnemyType("Leever", &SoulLeever, { 0x0000, 0x0001 }, // normal / big
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER, LocType::SPAWNER });
    enemyTypes[ENEMY_PEAHAT] = EnemyType("Peahat", &SoulPeahat, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_PEAHAT_LARVA] = EnemyType("Peahat Larva", &SoulPeahat, { 0x0001 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::UNDERWATER, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_LIZALFOS] = EnemyType("Lizalfos", &SoulLizalfosDinolfos, { 0xFF80, 0xFFFF }, // normal / drops from above when approached
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_DINOLFOS] = EnemyType("Dinolfos", &SoulLizalfosDinolfos, { 0xFFFE },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_GOHMA_LARVA] = EnemyType("Gohma Larva", &SoulGohma, { 0x0000, 0x0007 }, // egg that drops and hatches / stationary egg
        { LocType::ABOVE_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER, LocType::SPAWNER });
    enemyTypes[ENEMY_SHABOM] = EnemyType("Shabom", &SoulShabom, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::ABOVE_WATER, LocType::SHALLOW_WATER, LocType::SPAWNER });
    enemyTypes[ENEMY_DODONGO_BABY] = EnemyType("Dodongo (Baby)", &SoulDodongo, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER, LocType::SPAWNER });
    enemyTypes[ENEMY_DARK_LINK] = EnemyType("Dark Link", &SoulDarkLink, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_BIRI] = EnemyType("Biri", &SoulBiriBari, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::UNDERWATER, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_TAILPASARAN] = EnemyType("Tailpasaran", &SoulTailpasaran, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_SKULLTULA] = EnemyType("Skulltula", &SoulSkulltula, { 0x0000, 0x0001 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::UNDERWATER, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_TORCH_SLUG] = EnemyType("Torch Slug", &SoulTorchSlug, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND });
    enemyTypes[ENEMY_STINGER_FLOOR] = EnemyType("Stinger (Floor)", &SoulStinger, { 0x000A },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_MOBLIN_CLUB] = EnemyType("Moblin (Club)", &SoulMoblin, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_MOBLIN_SPEAR] = EnemyType("Moblin (Spear)", &SoulMoblin, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_ARMOS] = EnemyType("Armos", &SoulArmos, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_DEKU_BABA_SMALL] = EnemyType("Deku Baba (Small)", &SoulDekuBaba, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_DEKU_BABA_BIG] = EnemyType("Deku Baba (Big)", &SoulDekuBaba, { 0x0001 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_MAD_SCRUB] = EnemyType("Mad Scrub", &SoulDekuScrub, { 0x0100, 0x0300, 0x0500 }, // shoots 1, 3 or 5 nuts in a row
        { LocType::ABOVE_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_BARI] = EnemyType("Bari", &SoulBiriBari, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_BUBBLE_BLUE] = EnemyType("Bubble (Blue)", &SoulBubble, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_BUBBLE_FIRE] = EnemyType("Bubble (Fire)", &SoulBubble, { 0xFFFE },
        { LocType::ABOVE_GROUND });
    enemyTypes[ENEMY_BUBBLE_GREEN] = EnemyType("Bubble (Green)", &SoulBubble, { 0x02FC, 0x00FB }, // small / big
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_BUBBLE_WHITE] = EnemyType("Bubble (White)", &SoulBubble, { 0x00FD },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_FLYING_FLOOR_TILE] = EnemyType("Flying Floor Tile", &SoulFlyingTrap, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_BEAMOS] = EnemyType("Beamos", &SoulBeamos, { 0x0500, 0x0501 }, // big / small
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_FLOORMASTER] = EnemyType("Floormaster", &SoulWallmaster, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_REDEAD] = EnemyType("Redead", &SoulRedeadGibdo, { 0x7F01, 0x7F02 }, // standing / crouching
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_GIBDO] = EnemyType("Gibdo", &SoulRedeadGibdo, { 0x7FFE },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_POE_SISTER] = EnemyType("Poe Sister", &SoulPoe, { 0x0000 },
        { /* Unimplemented */ });
    enemyTypes[ENEMY_DEAD_HAND_HAND] = EnemyType("Dead Hand's Hand", &SoulDeadHand, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_SKULLWALLTULA] = EnemyType("Skullwalltula", &SoulSkulltula, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_FLARE_DANCER] = EnemyType("Flare Dancer", &SoulFlareDancer, { 0x0000 },
        { LocType::ABOVE_GROUND });
    enemyTypes[ENEMY_DEAD_HAND] = EnemyType("Dead Hand", &SoulDeadHand, { 0x0000 },
        { /* Unimplemented */ });
    enemyTypes[ENEMY_SHELL_BLADE] = EnemyType("Shell Blade", &SoulShellBlade, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_BIG_OCTO] = EnemyType("Big Octo", &SoulOctorok, { 0x0000 },
        { /* Unimplemented */ });
    enemyTypes[ENEMY_DEKU_BABA_WITHERED] = EnemyType("Deku Baba (Withered)", &SoulDekuBaba, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_LIKE_LIKE] = EnemyType("Like Like", &SoulLikeLike, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_PARASITIC_TENTACLE] = EnemyType("Parasitic Tentacle", &SoulParasiticTentacle, { 0x0000 },
        { /* Unimplemented */ });
    enemyTypes[ENEMY_SPIKE] = EnemyType("Spike", &SoulSpike, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_ANUBIS] = EnemyType("Anubis", &SoulAnubis, { 0x0003 },
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_IRON_KNUCKLE] = EnemyType("Iron Knuckle", &SoulGerudo, { 0xFF01, 0xFF02, 0xFF03 }, // silver / black / white
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_SKULL_KID] = EnemyType("Skull Kid", &SoulSkullKid, { 0xFFFF },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_FLYING_POT] = EnemyType("Flying Pot", &SoulFlyingTrap, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_FREEZARD] = EnemyType("Freezard", &SoulFreezard, { 0x0000, 0xFFFF }, // normal / appears and moves when approached
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_STINGER_WATER] = EnemyType("Stinger (Water)", &SoulStinger, { 0x0000 },
        { LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_HINT_DEKU_SCRUB] = EnemyType("Deku Scrub", &SoulDekuScrub, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::UNDERWATER, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_GERUDO_FIGHTER] = EnemyType("Gerudo Fighter", &SoulGerudo, { 0x0000 },
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER });
    enemyTypes[ENEMY_WOLFOS] = EnemyType("Wolfos", &SoulWolfos, { 0xFF00, 0xFF01 }, // normal / white
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER, LocType::SPAWNER });
    enemyTypes[ENEMY_STALCHILD] = EnemyType("Stalchild", &SoulStalchild, { 0x0000, 0x0005 }, // normal / big (20 kills)
        { LocType::ABOVE_GROUND, LocType::SHALLOW_WATER, LocType::SPAWNER });
    enemyTypes[ENEMY_GUAY] = EnemyType("Guay", &SoulGuay, { 0x0000, 0x0001 }, // normal / big
        { LocType::ABOVE_GROUND, LocType::NARROW_GROUND, LocType::ABOVE_VOID, LocType::UNDERWATER, LocType::ABOVE_WATER, LocType::SHALLOW_WATER });
};
